...
Одностраничный сайт-лендинг для компании, специализирующейся на производстве и установке шкафов для санузла по индивидуальным размерам. Проект включает готовый HTML/CSS/JS-лендинг и полный комплект маркетинговой аналитики.
